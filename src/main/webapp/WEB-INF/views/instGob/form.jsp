<%-- 
    Document   : form
    Created on : 10-jun-2017, 2:19:53
    Author     : luish
--%>
                ...
                <div class="mdl-grid portfolio-max-width portfolio-contact">
                    <div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
                        ...
                        <div class="mdl-card__supporting-text">
                            ...
                            <form action='<%=context_path%>/instGob/save' method='post'>
                                <table class='table table-hover table-responsive table-bordered'>
                                    <tr>
                                        <td><b>Estado de registro</b></td>
                                        <td>
                                            <select class='form-control' path="${institucion.regActivo}">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='text' name='ingCodigo' class='form-control' value="${institucion.ingCodigo}" required/></td>
                                    </tr>
                                    <tr>
                                        <td><b>Nombre Institucion</b></td>
                                        <td><input type='text' name='ingNombre' class='form-control' value="${institucion.ingNombre}" required/></td>
                                    </tr>
                                    <tr>
                                        <td><b>Direccion</b></td>
